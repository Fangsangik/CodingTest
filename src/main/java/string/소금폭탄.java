...
public class 소금폭탄 {
    public static void main(String[] args) {
        ...
        String[] inputCur = input.split(":");
        int curHour = Integer.parseInt(inputCur[0]);
        int curMinute = Integer.parseInt(inputCur[1]);
        int curSecond = Integer.parseInt(inputCur[2]);

        int curSecondAmount = curHour * 3600 + curMinute * 60 + curSecond;

        String[] dropCur = drop.split(":");
        int dropHour = Integer.parseInt(dropCur[0]);
        int dropMinute = Integer.parseInt(dropCur[1]);
        int dropSecond = Integer.parseInt(dropCur[2]);
